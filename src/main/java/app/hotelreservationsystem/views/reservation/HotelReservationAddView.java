...
public class HotelReservationAddView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnClearReservation.setIcon(new javax.swing.ImageIcon(getClass().getResource("/app/hotelreservationsystem/views/icons/clear.png"))); // NOI18N
        btnClearReservation.setText("Clear");

        btnAddReservation.setBackground(javax.swing.UIManager.getDefaults().getColor("Actions.Grey"));
        btnAddReservation.setIcon(new javax.swing.ImageIcon(getClass().getResource("/app/hotelreservationsystem/views/icons/add.png"))); // NOI18N
